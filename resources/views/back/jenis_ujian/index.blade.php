    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <a href="#" class="btn btn-primary mb-3" data-toggle="modal" data-target="#modal-jenis_ujian"><i class="fas fa-plus-circle"></i> Tambah Data</a>         
                ...
                <form id="form-jenis-ujian" action="" method="POST">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group" id="nama_ujian_container">
                      ...
                      <input type="text" class="form-control phone-inputmask" name="nama_ujian" id="nama_ujian" placeholder="Masukkan Nama Ujian">
                    </div>
                    <div class="form-group" id="tanggal_ujian_container">
                      <label for="tanggal_ujian">Tanggal Ujian</label>  
                      <input type="date" class="form-control phone-inputmask" name="tanggal_ujian" id="tanggal_ujian">
                    </div>
                  ...
                  <div class="card-footer">
                    <button type="submit" class="btn btn-primary" id="btn-save-jenis_ujian"><i class="fas fa-save"></i> Simpan</button>
                  ...
                  <form id="form-jenis-ujian-edit" action="" method="POST">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group" id="nama_ujian_edit_container">
                        ...
                        <input type="text" class="form-control phone-inputmask" name="nama_ujian" id="nama_ujian_edit">
                      </div>
                      <div class="form-group" id="tanggal_ujian_edit_container">
                        <label for="tanggal_ujian_edit">Tanggal Ujian</label>  
                        <input type="date" class="form-control phone-inputmask" name="tanggal_ujian" id="tanggal_ujian_edit">
                      </div>
      ...
      $.ajax({
        ...
        error: function(xhr) {
          if(xhr.status !== 422) { // Cek jika bukan error validasi
            $('#modal-jenis_ujian').modal('hide'); // Sembunyikan modal hanya jika bukan error validasi
          }
