			...
			<div class="col-sm-12 my-auto">
				<div class="card border-0">
				  <div class="row">
				    <div class="col-md-8">
				      <div class="card-body">
				      	<img src="https://c0.wallpaperflare.com/preview/331/257/138/registration-login-keyboard-man.jpg" class="img-fluid rounded-start shadow" alt="...">
				      </div>
				    </div>
				    <div class="col-md-4">
				      <div class="card-body">
				      	<div class="mb-5 text-center">
				      		<img src="https://ltpresent.com/assets/front/assets/images/icon-96x96.png" class="img-fluid" width="70" alt="logo ahmad syarifudin" title="ahmad, syarifudin">
