        ...
        <div class="card">
            <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($details as $detail)
                                <tr>
                                    ...
                                    <td hidden>ID <input type="text" name="waktu_mengajar_id[]" value="{{ $detail->waktuMengajar->id }}"></td>
                ...
                <div class="border-top">
                    <div class="card-body">
                        <button type="submit" class="btn btn-success" style="color:white;"><i class="fas fa-save"></i> Cetak/Simpan</button>
                        <a href="/tampilkan-jadwal" class="btn btn-danger" style="color:white;"><i class="fas fa-step-backward"></i> Kembali</a>
                    </div>
                </div>
            </div>
        </div>
